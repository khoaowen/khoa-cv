...
export const ui = {
  en: {
    ...
    'action.downloadDossier': 'Download skills dossier',
    'action.downloadDossierSub': 'Full CV PDF version',
  ...
  fr: {
    ...
    'action.downloadDossier': 'Télécharger le dossier de compétences',
    'action.downloadDossierSub': 'Version PDF complète',
    'action.viewLinkedin': 'LinkedIn',
